...
help:
	...
	@echo "  LLAMA_ARGS    - Arguments for llama.cpp (e.g., \"--threads 4 --ctx-size 2048\")"
	@echo ""
	@echo "Example usage:"
	@echo "  make run LLAMA_ARGS=\"--threads 4 --ctx-size 2048\""
	@echo "  make docker-run LLAMA_ARGS=\"--threads 4 --ctx-size 2048\""
